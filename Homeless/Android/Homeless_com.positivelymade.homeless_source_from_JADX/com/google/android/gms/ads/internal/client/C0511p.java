...
public interface C0511p extends IInterface {

    public static abstract class C0512a extends Binder implements C0511p {

        private static class C0530a implements C0511p {
            private IBinder f1452a;
            ...
            public void mo386a() {
                ...
                try {
                    ...
                    this.f1452a.transact(1, obtain, obtain2, 0);
        ...
        public static C0511p m2364a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.client.IAdClickListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0511p)) ? new C0530a(iBinder) : (C0511p) queryLocalInterface;
        }
