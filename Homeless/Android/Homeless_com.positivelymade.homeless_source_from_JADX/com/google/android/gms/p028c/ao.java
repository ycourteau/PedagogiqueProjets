...
public class ao {
    public static int m3844a(String str) {
        byte[] bytes;
        try {
        ...
        return ir.m5283a(bytes, 0, bytes.length, 0);
    }

    static boolean m3845a(int i) {
        return Character.isLetter(i) && (ao.m3846a(UnicodeBlock.of(i)) || ao.m3847b(i));
    }

    private static boolean m3846a(UnicodeBlock unicodeBlock) {
    ...
    private static boolean m3847b(int i) {
        return (i >= 65382 && i <= 65437) || (i >= 65441 && i <= 65500);
    }

    public static String[] m3848b(String str) {
        if (str == null) {
            return null;
        }
