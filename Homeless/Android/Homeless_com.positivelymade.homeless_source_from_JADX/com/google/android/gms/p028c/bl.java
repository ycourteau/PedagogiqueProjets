...
public interface bl extends IInterface {
    ...
    public static abstract class C0560a extends Binder implements bl {

        private static class C0834a implements bl {
            private IBinder f2540a;
            ...
            public C0799a mo409a() {
                ...
                try {
                    ...
                    this.f2540a.transact(1, obtain, obtain2, 0);
            ...
            public Uri mo410b() {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.formats.client.INativeAdImage");
                    this.f2540a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
        ...
        public static bl m2488a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.formats.client.INativeAdImage");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof bl)) ? new C0834a(iBinder) : (bl) queryLocalInterface;
        }
